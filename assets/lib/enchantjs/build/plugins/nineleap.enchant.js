...
(function() {
    ...
    enchant.nineleap = { assets: ['assets/lib/enchantjs/images/start.png', 'assets/lib/enchantjs/images/end.png'] };
    ...
    enchant.nineleap.Core = enchant.Class.create(enchant.Core, {
        ...
        initialize: function(width, height) {
            ...
            this.addEventListener('load', function() {
                ...
                this.startScene.image = this.assets['assets/lib/enchantjs/images/start.png'];
                ...
                this.endScene.image = this.assets['assets/lib/enchantjs/images/end.png'];
